 ...
 <div class="row">
  <div class="col-md-5">
    ...
    <div class="container-fluid">
      ...
      <h3>Born: july 1991(age script)</h3>
      <h2 class="text-center">Contacts</h2>
      <p class="text-center"><img class="custom_skype" src="/theme/icons/skype-icon.png" /><i> kobe_orc</i></p>
      <div class="row">
        <div class="col-md-3"><a target="blank" href="http://vk.com/kobeorc"><img class="img-responsive" src="/theme/icons/vk-icon.png" /></a></div>
        <div class="col-md-3"><a target="blank" href="https://www.facebook.com/profile.php?id=100001648843184"><img class="img-responsive" src="/theme/icons/facebook-icon.png" /></div>
        <div class="col-md-3"><a target="blank" href="http://twitter.com/kobeorc"><img class="img-responsive" src="/theme/icons/twitter-icon.png" /></a></div>
        <div class="col-md-3"><a target="blank" href="https://plus.google.com/110946708756852717793/posts"><img class="img-responsive" src="/theme/icons/google-icon.png" /></a></div>
      </div>
    </div>
  </div>
